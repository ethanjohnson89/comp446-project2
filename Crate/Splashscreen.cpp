...
void Splashscreen::init(ID3D10Device* device, float scale)
{
	md3dDevice = device;
...
void Splashscreen::init(ID3D10Device* device, float scale, ID3D10ShaderResourceView* mDMRV, ID3D10ShaderResourceView* mSMRV, ID3D10EffectTechnique* mT)
{
	mDiffuseMapRV = mDMRV;
	mSpecMapRV = mSMRV;
	mTech = mT;
